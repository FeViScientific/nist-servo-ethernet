// LOCKINconfig and PHASEDETconfig are declared and assigned in the top-level module.
// In the original design they were assigned from configuration[5119:4096] and [6143:5120].
// In the Ethernet version they come from distributed config registers.
