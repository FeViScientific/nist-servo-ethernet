...
///////////////////////////////////////////////////////////////////////////////
// DSP Clock Generator - 25 MHz from 100 MHz (divide by 4)
// clk_dsp is a true clock for the DSP chain, distributed via BUFG
reg [1:0] clk_div_counter;
wire clk_dsp_unbuf = clk_div_counter[1];  // MSB toggles at 1/4 rate
wire clk_dsp;
...
BUFG bufg_clk_dsp (.I(clk_dsp_unbuf), .O(clk_dsp));

// Clock enable for 100 MHz domain modules that need to know when clk_dsp rises
// This is high for one clk1 cycle when clk_dsp has a rising edge
...
// FractionalDAC instances for slow DSP interpolation
// Takes 18-bit input (16-bit integer + 2-bit fractional), outputs 16-bit at 100 MHz
// Delta-sigma modulator averages to fractional value over 4 cycles
...
FractionalDAC FractionalDAC0 (
	...
	.rst_in(rst),
	.ce(ce),
	.dac_in(DACin[0][SIGNAL_SIZE-1:SIGNAL_SIZE-18]),
...
FractionalDAC FractionalDAC1 (
	...
	.rst_in(rst),
	.ce(ce),
	.dac_in(DACin[1][SIGNAL_SIZE-1:SIGNAL_SIZE-18]),
...
//	.DAC0_in(DACin[0][SIGNAL_SIZE-1:SIGNAL_SIZE-16]),  // Original: direct 16-bit
//	.DAC1_in(DACin[1][SIGNAL_SIZE-1:SIGNAL_SIZE-16]),  // Original: direct 16-bit
	.DAC0_in(DAC0_fractional),  // Slow DSP: via FractionalDAC delta-sigma
	.DAC1_in(DAC1_fractional),  // Slow DSP: via FractionalDAC delta-sigma
