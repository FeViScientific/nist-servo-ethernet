...
// Note: PLL configuration is hardcoded in memc3_infrastructure.v to match Opal Kelly XEM6010 reference design:
//   Input: 100 MHz (clk1_in) → PLL: (100MHz/4)*25 = 625 MHz → DDR2 clock: 312.5 MHz (625 MT/s)
//   Original NIST parameters (removed) would have produced 100 MHz DDR2 clock (too slow)
//   C_MEMCLK_PERIOD = 3200 ps = 312.5 MHz matches the hardcoded PLL and MT47H64M16XX-3 specs (max 333 MHz)
